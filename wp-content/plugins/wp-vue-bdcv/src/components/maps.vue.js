    ...
    methods:{
        ...
        get_coords(){
            ...
            for(var i=0; i < this.api_data.length; i++){
                ...
                for(var j=0; j < coordinates.length; j++){
                    ...
                    marker.bindPopup('<a style="font-size: 12px" href="#/docs?id='+ elemento.id +'&amp;has_model='+ elemento.has_model_ssim[0] +'&amp;thumbnail='+ elemento.thumbnail_path_ss +'&amp;related='+ elemento.hasRelatedMediaFragment_ssim[0] +'&amp;back_maps=true">' + elemento.title_tesim[0] + '</a>', {
                        closeButton: false
                    }).openPopup();
        ...
        create_list(){
            ...
            for(var i = 0; i < this.data_markers.length; i++){
                ...
                item.innerHTML = '<a href="#/mapa">' + data.name + '</a>';
