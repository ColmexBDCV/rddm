<body class="body-special">
    ...
    <div w3-include-html="/wp-content/plugins/wp-vue-bdcv/src/templates/maps.html"></div>
    <div w3-include-html="/wp-content/plugins/wp-vue-bdcv/src/templates/advancedview.html"></div>
    ...
    <template id="home">
        <div class="d-flex">
            ...
            <div class="p-4 show-all">
                <search :keyword="keyword" :pages="repo.pages" :filter="filter" :search_in="search_in"
                        is_page="false" :json_data="json_data"></search>
    ...
    <template id="searchview">
        <div class="row">
            <div class="col-3 col-normal">
                <facets :facets="repo.facets" :search_in="search_in" :type="this.type" :val="this.val" :label="this.label" :params="this.params">
                </facets>
            </div>
                                ...
                                <tr v-for="(metadata, key, index) in doc" v-if="check_metadata(metadata, key)">
                                    ...
                                    <td v-if="isObject(metadata)" style="text-align: left;">
                                        ...
                                        <p v-for="m in metadata">
                                            ...
                                            <a v-else v-on:click="reload('type=' + key + '_sim&val=' + m +'&label=' + $t(key))" :href="'/busqueda/#/search?type=' + key + '_sim&val=' + m +'&label=' + $t(key) + '&reload=true'">{{ m }}</a>
                                        </p>
                                    </td>
    ...
    <template id="pages">
        <div id="pages-div">
            <nav aria-label="Paginas disponibles" style="text-align: center;" v-if="pages != undefined">
                <ul class="pagination">
    ...
    <template id="helperbar">
        <div>
            ...
            <div style="width: 96%;display: flow-root;">
                <div class="btn-group paginator-top" v-if="pages != undefined">
								...
								<slot name="body">
									<ul class="list-group">
                                        ...
                                        <li v-for="item in data_local" class="list-item-modal">
                                            <a @click="query(item.value)">
                                            <span class="facet-label">
                                                {{item.value}}
                                            </span>
                                            <span style="float: right;" class="facet-label">
                                                {{item.hits}}
                                            </span>
                                            </a>
                                        </li>
...
<script src="https://unpkg.com/leaflet.markercluster@1.4.1/dist/leaflet.markercluster-src.js" async></script>
<!--</script>-->
