...
define('KOKO_ANALYTICS_BUFFER_FILE', '/opt/bitnami/apps/wordpress/htdocs/wp-content/uploads/pageviews.php');

// path to functions.php file in Koko Analytics plugin directory
require '/opt/bitnami/apps/wordpress/htdocs/wp-content/plugins/koko-analytics/src/functions.php';
